...
bool ClipToFace(S2Point const& a, S2Point const& b, int face,
...
bool ClipToPaddedFace(S2Point const& a, S2Point const& b, int face,
...
extern double const kFaceClipErrorRadians;
extern double const kFaceClipErrorUVDist;
extern double const kFaceClipErrorUVCoord;
...
extern double const kIntersectsRectErrorUVDist;
...
// returns false.)
bool ClipEdgeBound(R2Point const& a, R2Point const& b,
...
extern double const kEdgeClipErrorUVCoord;
extern double const kEdgeClipErrorUVDist;
...
inline bool ClipToFace(S2Point const& a, S2Point const& b, int face,
                       R2Point* a_uv, R2Point* b_uv) {
