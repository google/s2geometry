...
const int S2RegionCoverer::kDefaultMaxCells;
...
void S2RegionCoverer::GetCellUnion(const S2Region& region,
...
void S2RegionCoverer::GetInteriorCellUnion(const S2Region& region,
