...
constexpr const T& clamp(const T& v, const T& lo, const T& hi) {
  return ::s2::absl::clamp(v, lo, hi, algorithm_internal::Less{});
}
...
bool equal(InputIter1 first1, InputIter1 last1, InputIter2 first2,
           InputIter2 last2) {
  return ::s2::absl::equal(first1, last1, first2, last2,
...
// `ForwardIterator` is not a random-access iterator, then `::s2::absl::rotate`
