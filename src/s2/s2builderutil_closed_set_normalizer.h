...
//   layers[0] = s2::absl::make_unique<IndexedS2PointVectorLayer>(index);
//   layers[1] = s2::absl::make_unique<IndexedS2PolylineVectorLayer>(
//       index, polyline_options);
//   layers[2] = s2::absl::make_unique<IndexedS2PolygonLayer>(index);
