...
class PyWrapS2TestCase(unittest.TestCase):
    ...
    def testS2CellIdGetVertexNeighborsIsWrappedCorrectly(self):
        cell = s2.S2CellId(0x466D319000000000)
        expected_neighbors = [
            s2.S2CellId(0x466D31C000000000),
    ...
    def testS2CellIdGetAllNeighborsIsWrappedCorrectly(self):
        cell = s2.S2CellId(0x466D319000000000)
        expected_neighbors = [
            s2.S2CellId(0x466D31D000000000),
    ...
    def testS2CellIdGetAllNeighborsIsWrappedCorrectly(self):
        ...
        expected_neighbors = (
            s2.S2CellId(0x2AB3530000000000),
    ...
    def testS2PolygonGetAreaIsWrappedCorrectly(self):
        ...
        london_level_10 = s2.S2CellId(
            s2.S2LatLng.FromDegrees(51.5001525, -0.1262355)
        ).parent(10)
    ...
    def testGetS2LatLngVertexIsWrappedCorrectly(self):
        ...
        self.assertEqual(
            "51.500152,-0.126235", first_vertex.ToStringInDegrees()
        )
        second_vertex = loop.GetS2LatLngVertex(1)
        self.assertIsInstance(second_vertex, s2.S2LatLng)
        self.assertEqual(
            "51.500153,-0.126235", second_vertex.ToStringInDegrees()
        )
    ...
    def testGetLastDescendant(self):
        ...
        loop3 = verts2loop([(0, 20), (0, 30), (10, 30), (10, 20)])  # Shell
    ...
    def testS2PolygonBoundaryNearIsNear(self):
        ...
        self.assertTrue(
            polygon_1.BoundaryNear(polygon_2, s2.S1Angle.Degrees(1))
        )
    ...
    def testS2Rotate(self):
        ...
        self.assertEqual(
            "37.439095,-121.967802", s2.S2LatLng(point).ToStringInDegrees()
        )
    ...
    def testS2LatLngRectRegion(self):
        rect = s2.S2LatLngRect(
            s2.S2LatLng.FromDegrees(1.0, 2.0), s2.S2LatLng.FromDegrees(3.0, 4.0)
        )
    ...
    def testS2CellIdCenterSiTi(self):
        cell = s2.S2CellId.FromFacePosLevel(
            3, 0x12345678, s2.S2CellId.kMaxLevel
        )
    ...
    def testS2Interpolate(self):
        ...
        self.assertEqual(
            "3.500133,4.499733", s2.S2LatLng(p3).ToStringInDegrees()
        )
...
class S2PolylineTest(unittest.TestCase):
    ...
    def testIntersects(self):
        line1 = s2.S2Polyline()
        line1.InitFromS2LatLngs([
            s2.S2LatLng.FromDegrees(-1.0, 0.0),
            s2.S2LatLng.FromDegrees(1.0, 0.0),
        ])
        line2 = s2.S2Polyline()
        line2.InitFromS2LatLngs([
...
class S2LatLngRectTest(unittest.TestCase):
    ...
    def testArea(self):
        r = s2.S2LatLngRect(
            s2.S2LatLng.FromDegrees(0.0, 0.0), s2.S2LatLng.FromDegrees(1.0, 1.0)
        )
        self.assertGreater(r.Area(), 0.0)

    def testGetCenter(self):
        r = s2.S2LatLngRect(
            s2.S2LatLng.FromDegrees(0.0, 0.0), s2.S2LatLng.FromDegrees(2.0, 4.0)
        )
        c = r.GetCenter()
    ...
    def testIntersectionAndUnion(self):
        r1 = s2.S2LatLngRect(
            s2.S2LatLng.FromDegrees(0.0, 0.0), s2.S2LatLng.FromDegrees(2.0, 2.0)
        )
        r2 = s2.S2LatLngRect(
            s2.S2LatLng.FromDegrees(1.0, 1.0), s2.S2LatLng.FromDegrees(3.0, 3.0)
        )
...
class RegionTermIndexerTest(unittest.TestCase):
    ...
    def _randomCaps(self, query_type, **indexer_options):
        ...
        for i in range(ITERATIONS):
            ...
            print(
                "Index terms/doc: %0.2f, Query terms/doc: %0.2f"
                % (
    ...
    def testMaxLevelSetLoosely(self):
        ...
        self.assertEqual(
            indexer1.GetIndexTerms(point, ""), indexer2.GetIndexTerms(point, "")
        )
        self.assertEqual(
            indexer1.GetQueryTerms(point, ""), indexer2.GetQueryTerms(point, "")
        )

        cap = s2.S2Testing.GetRandomCap(0.0, 1.0)
        self.assertEqual(
            indexer1.GetIndexTerms(cap, ""), indexer2.GetIndexTerms(cap, "")
        )
        self.assertEqual(
            indexer1.GetQueryTerms(cap, ""), indexer2.GetQueryTerms(cap, "")
        )
...
class S2PolygonTestCase(unittest.TestCase):
    ...
    def testInitToUnionDistinct(self):
        ...
        cell2 = s2.S2Cell(
            s2.S2CellId(s2.S2LatLng.FromDegrees(13.0, 4.0)).parent(8)
        )
        polygon2 = s2.S2Polygon(cell2)
...
class S2BooleanOperationTest(unittest.TestCase):
    ...
    def operate(self):
        ...
        op = s2.S2BooleanOperation(s2.S2BooleanOperation.OpType_UNION, layer)
